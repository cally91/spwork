...
public class BookVO {
		...
		private	long b_sep; // NUMBER PRIMARY KEY,
		...
		public BookVO(long b_sep, String b_title, String b_comp, String b_auth, int b_price) {
			super();
			this.b_sep = b_sep;
		...
		public long getB_sep() {
			return b_sep;
		}
		public void setB_sep(long b_sep) {
			this.b_sep = b_sep;
		}
		...
		public String toString() {
			return "BookVO [b_sep=" + b_sep + ", b_title=" + b_title + ", b_comp=" + b_comp + ", b_auth=" + b_auth
					+ ", b_price=" + b_price + "]";
		}
