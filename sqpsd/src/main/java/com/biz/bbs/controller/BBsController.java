...
public class BBsController {
	...
	public String write_up(@ModelAttribute BBsReqDto bbsReqDto, SessionStatus sStatus, Model model) {
		 ...
		 * vo(dto)에 한번 담긴 값은 웹 브라이져가 열려있는동안
		 * 항상 유지되는 겅질이 있다.
		 * 그래서, wtite(POST) update(Post) 를 수행한 후
		 */
		sStatus.setComplete();
	 ...
	 * 될수 있다.
	 * 
	 * path/값 형식의 주소처럼 서버로 데이터를 보내고 컨트롤러에서는 주소의 일부를 값으로 인식하여 변수에 할당하는 방식이다.
	 * 
	 */
