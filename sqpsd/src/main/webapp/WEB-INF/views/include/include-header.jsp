...
<header>
	<h2>
		<a href="${rootPath}/"><img src="${rootPath}/resources/image/KakaoTalk_20190710_222114516.png"></a>
	</h2>
</header>
<style>
.dropbtn {
...
<nav>
	<ul class="main-menu">
		...
		<c:if test="${empty LOGIN }">
			<li class="memder"><a href="${rootPath}/member/login">로그인</a></li>
			<li><a href="${rootPath}/member/login">회원가입</a></li>
		</c:if>
		<c:if test="${!empty LOGIN }">
			<li class="memder"><a href="${rootPath}/member/logout">로그아웃</a></li>
